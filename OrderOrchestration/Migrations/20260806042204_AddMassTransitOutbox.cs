...
namespace OrderOrchestration.Migrations
{
    ...
    public partial class AddMassTransitOutbox : Migration
    {
        ...
        {
            // Idempotent: các bảng này có thể đã được tạo bởi WebApp (ApplicationInitializer)
            // trên cùng schema public, nên dùng CREATE TABLE IF NOT EXISTS để không xung đột.
